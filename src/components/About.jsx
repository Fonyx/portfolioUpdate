...
const About = (props) => {
    ...
    return (
        <Row>
            <p>Hi, my name is</p>
            <h2>Nicholas Ritchie</h2>
            <h3>And I build things....internet things</h3>
            <p>I'm a full stack developer completing my bootcamp with USYD and trilogy. In the near future I am looking to get into fin tech development and I have a background in data-science and manufacturing.</p>
