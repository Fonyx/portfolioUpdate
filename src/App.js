...
function App() {
  return (
    <div className="App quaternary_bg">
      <header>
        <MaterializeNavbar bg_color='primary_bg' text_color='senary_text'/>
        <img className="navbarIcon" src="./assets/icons/flower_fox_orange.svg" alt="fonyx logo"></img>
      </header>
      <main className="quaternary_bg">
        <SvgSection />
        <Piece showGifUrl="https://github.com/Fonyx/budgie/blob/main/assets/images/show.gif?raw=true" title="Budgie" repoUrl="https://github.com/Fonyx/budgie" deploymentUrl="https://fonyx-budgie.herokuapp.com/"/>
      </main>
      <Footer
        className="example"
